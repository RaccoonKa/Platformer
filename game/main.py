...
from game.subsystems.scripts import LogInfoParams, MarioChaseInfoParams, PatrolInfoParams, \
    MoveLeftInfoParams, MoveRightInfoParams, JumpInfoParams
...
def create_test_level()-> Level:
    ...
    level.add_sound('sound','assets/sound/jump.mp3',0.1)
...
def test2()-> None:
    ...
    print(len(i.objects) for i in game.layer_system.layers)
    game.game_loop()

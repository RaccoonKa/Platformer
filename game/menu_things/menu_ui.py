import pygame
from game.menu_classes.menu_background import DynamicBackgroundManager
from game.menu_classes.menu_animations import FadeAnimation
from game.menu_classes.menu_objects import Text, MenuItem
from game.menu_classes.menu_music import Slider
...
def create_intro(screen):
    ...
    animator.fade_in(intro, duration = 2)
    pygame.time.delay(3000)
    animator.fade_out(intro, duration = 2)
...
def create_settings_elements(game_width, game_height, music, sound_volume):
    settings_title = Text(
        text = "SETTINGS",
